...
export function GraderClient({
  ...
  const features = t.raw("features") as Array<{ t: string; d: string }>;
  const moreInfo = t.raw("moreInfo") as Array<{
    q: string;
  ...
  const footerColumns: Array<{
  ...
  }> = [
    {
      ...
      links: [
        { label: t("footerFeatures"), href: "/", hash: "ozellikler" },
        { label: t("footerHowItWorks"), href: "/", hash: "nasil-calisir" },
      ],
    },
    {
      ...
      links: [
        ...
        { label: t("footerFaq"), href: "/", hash: "faq" },
      ],
    },
    {
      ...
      <footer className="relative overflow-clip bg-brand-dark pb-14 pt-12">
        ...
        <div className={`relative ${GRADER_SHELL_PAD}`}>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-6 text-xs text-white/40">
            <p>© 2026 Score AI. {t("footerRights")}</p>
            <p>{t("footerTagline")}</p>
            <a
              href="mailto:info@usescore.net"
              className="flex items-center gap-1.5 transition hover:text-white"
              aria-label={t("footerEmailLabel")}
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 transition hover:text-white"
              aria-label={t("footerLocationLabel")}
            >
